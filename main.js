...
// adapter will be restarted automatically every time as the configuration changed, e.g system.adapter.solvis.0
...
function main() {
     ...
     *
     *      Here a simple solvis for a boolean variable named "testVariable"
     *
    ...
    // in this solvis all states changes inside the adapters namespace are subscribed
